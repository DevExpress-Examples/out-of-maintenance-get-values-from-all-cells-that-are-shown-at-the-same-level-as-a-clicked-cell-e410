...
Namespace WindowsFormsApplication1
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class InvoicesDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddInvoicesRow(ByVal Customers_CompanyName As String, ByVal OrderDate As System.DateTime, ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single) As InvoicesRow
				Dim rowInvoicesRow As InvoicesRow = (CType(Me.NewRow(), InvoicesRow))
				Dim columnValuesArray() As Object = { Customers_CompanyName, OrderDate, ProductName, UnitPrice, Quantity, Discount}
...
Namespace WindowsFormsApplication1.nwindDataSetTableAdapters
	...
	Partial Public Class InvoicesTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT [Customers.CompanyName], OrderDate, ProductName, UnitPrice, Quantity, Disc" & "ount FROM Invoices"
